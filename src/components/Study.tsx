...
const Study = () => {
  return (
    <div className="min-h-screen mt-40 lg:mt-10">
      ...
      <div>
        <StudyCard img={PG} gradiuate="Post-Gradiuate " date="July 2023 ~ July 2025" course="Master of Computer Applications-(MCA)" collageName="G H Raisoni College of Engineering ,Amravati"/>
