...
import PawFectCare from "../../assets/pawFectCare.png"
...
const Complete = () => {
  return (
      <div className="flex flex-wrap  lg:h-[160vh] h-fit gap-60 lg:gap-0 justify-center mt-10">
        ...
        />
        <ProjectCard
          to="https://pawfect-care.vercel.app/"
          github="PawfectCare🐾"
          techStack={pawfectCare}
          projectLink="https://pawfect-care.vercel.app/"
          img={PawFectCare}
          projectName="PawfectCare🐾"
          desc="PawfectCare is a full-stack web application designed to simplify pet healthcare management for pet owners and veterinary clinics. The platform allows users to schedule appointments, track medical history and maintain pet profiles — all in one place."
        />
        <ProjectCard
